...
public class StringStuff {
   ...
   */
   public static boolean containsVowel( String s ) {
      if ( (true == s.contains("A")) || (true == s.contains("a")) || (true == s.contains("E")) || (true == s.contains("e")) || (true == s.contains("I")) || (true == s.contains("i")) || (true == s.contains("O")) || (true == s.contains("o")) || (true == s.contains("U")) || (true == s.contains("u")) || (true == s.contains("Y")) || (true == s.contains("y")) ){
		     return true;
	    }
	    return false;
   }
   ...
   */
   public static boolean isPalindrome( String s ) {
     int i = 0;
     while ( i <= ((int) Math.ceil(s.length()/2) ) ) {
        if ( s.charAt((int) i) != s.charAt((s.length()- (int) i - 1)) ) {
          return false;
        }
        i += 1;
      }
