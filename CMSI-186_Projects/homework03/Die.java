...
public class Die {
   ...
   */
   ...
   public Die ( int nSides ) throws IllegalArgumentException {
      if (nSides < MINIMUM_SIDES) {
        throw new IllegalArgumentException("Error. There is no such as a" + nSides + "sided die. A die must have, at minimum, 4 sides. \n Please re-enter a valid sided die.");
      }
      sides = nSides;
      pips = 0;
   }
   ...
   */
   public int getValue() throws IllegalArgumentException{
      if (pips == 0) {
        throw new IllegalArgumentException( "You must first roll the die before getting the value!");
      }
      return pips;
   }
   ...
   */
   public void setSides( int sides ) throws IllegalArgumentException{
     if (sides < MINIMUM_SIDES) {
       throw new IllegalArgumentException("Error. There is no such as a" + sides + "sided die. A die must have, at minimum, 4 sides. \n Please re-enter a valid sided die.");
     }
     sides = sides;
   }
